...
4. 打开 X 帖子详情页，已加载的评论进入视野后开始工作。单条评论详情页也支持：使用页面上方完整的原帖与上级回复作为上下文。

如果上方原帖被“显示更多”截断，评论时间旁显示“评审 · 打开原帖”。可展开上下文，或点击进入原帖的评论列表；插件不会用残缺内容检测或发送投票。仅同一页面虚拟滚动移出视野的已读上下文会临时保留，切换帖子即清除。
